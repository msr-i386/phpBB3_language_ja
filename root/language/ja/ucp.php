...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_INACTIVE'				=> 'アカウントは作成されました。ログインするにはアカウントの有効化が必要です。有効化キーは既にあなたのメールアドレスに送信済みです。詳細はメールをご確認ください。また、迷惑メールボックスに入っていないかご確認ください。サービスプロバイダによっては、メールの到着まで時間がかかることがあります。',
	...
	'AVATAR_EXPLAIN_NO_FILESIZE'	=> '使用可能な最大サイズ; 横幅: %1$s, 高さ: %2$s.',
	...
	'NO_AUTH_PRINT_MESSAGE'			=> 'プライベートメッセージを印刷する権限がありません',
	...
	'EMAIL_NOT_UNIQUE'			=> '指定されたメールアドレスは複数のユーザーによって使用されています。ユーザー名も指定してください',
	...
	'PASSWORD_UPDATED_IF_EXISTED'	=> 'あなたのアカウントが存在していれば、パスワードを記載したメールがあなたのメールアドレス宛てに送信されているはずです。メールが到着しない場合は、アカウントが禁止されているか、有効化されていないか、パスワードを変更する許可がないかのいずれかの可能性があります。それらの理由のいずれかに当てはまる場合は管理者に連絡してください。また、迷惑メールフィルターに引っかかっていないかも確認してください。',
