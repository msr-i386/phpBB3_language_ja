...
$lang = array_merge($lang, array(
	...
	'ACP_SHORT'						=> 'AdminCP',
	'ACTIVE'						=> '有効',
	'ACTIVE_ERROR'					=> '指定されたユーザーのアカウントは現在無効です。アカウントの有効化に関して問題がある場合は管理人にご連絡ください。',
	'ADMINISTRATOR'					=> 'Admin',
	...
	'AJAX_ERROR_TEXT_PARSERERROR'	=> 'リクエストに何か問題があった為にサーバから不正な応答が返ってきました',
	'ALLOWED'						=> '許可',
	'ALL_FILES'						=> '全てのファイル',
	'ALL_FORUMS'					=> '全てのフォーラム',
	...
	'AUTHOR'						=> '作成者',
	'AUTH_NO_PROFILE_CREATED'		=> 'ユーザープロファイルの作成に失敗しました',
	...
	'AVATAR_EMPTY_FILEUPLOAD'		=> 'アップロードされたアバター画像のファイルサイズが空です',
	'AVATAR_INVALID_FILENAME'		=> '%s のファイル名が正常ではありません',
	'AVATAR_NOT_UPLOADED'			=> 'アバター画像をアップロードできませんでした',
	'AVATAR_NO_TEMP_DIR'			=> '一時フォルダーが見つからない、または書き込みできませんでした',
	...
	'AVATAR_PHP_UPLOAD_STOPPED'		=> 'PHP拡張がファイルのアップロードを停止しました。',
	...
	'COOKIE_CONSENT_MSG'	=> 'このウェブサイトは、最良のエクスペリエンスを得られるようにするために Cookie を使用します。',
	...
	'DELETE'				=> '削除',
	'DELETE_ALL'			=> '全て削除',
	'DELETE_COOKIES'		=> 'Cookie を削除する',
	'DELETE_MARKED'			=> 'マークしたものを削除',
	'DELETE_POST'			=> '削除する',
	'DELIMITER'				=> '区切り文字',
	'DESCENDING'			=> '降順',
	'DISABLED'				=> '無効',
	...
	'EMAIL_SMTP_ERROR_RESPONSE'			=> 'メール送信中にエラーが発生しました。<br /><strong>エラー行: %1$s</strong><br />サーバからのレスポンス: %2$s',
	'EMPTY_SUBJECT'						=> 'トピックを投稿するには件名を入力する必要があります',
	'EMPTY_MESSAGE_SUBJECT'				=> 'メッセージを送信するには件名を入力する必要があります',
	'ENABLED'							=> '有効',
	'ENCLOSURE'							=> '囲み文字',
	'ENTER_USERNAME'					=> 'ユーザー名を入力してださい',
	'ERR_CHANGING_DIRECTORY'			=> 'ディレクトリを変更できませんでした',
	...
	'FAQ'					=> 'FAQ',
	'FAQ_EXPLAIN'			=> 'よくある質問',
	'FEATURE_NOT_AVAILABLE' => '要求されたリクエストはこの掲示板では利用できません。',
	'FILENAME'				=> 'ファイル名',
	'FILESIZE'				=> 'サイズ',
	'FILEDATE'				=> '日付',
	'FILE_COMMENT'			=> 'コメント',
	...
	'GROUP_ERR_USER_LONG'		=> '入力した グループ名 は長すぎます。グループ名は 60 字以内である必要があります。',
	'GUEST'						=> 'ゲスト',
	...
	'INSECURE_REDIRECT'			=> '安全でない疑いのある URL にリダイレクトしようとしました',
	'INTERESTS'					=> '興味',
	'INVALID_DIGEST_CHALLENGE'	=> 'Digest 認証のチャレンジが不正です',
	'INVALID_EMAIL_LOG'			=> 'メールアドレス <strong>%s</strong> が正しくない可能性があります',
	'INVALID_FEED_ATTACHMENTS'	=> '選択したフィードが、無効な制約で添付ファイルを取得しようとしました。',
	'INVALID_PLURAL_RULE'		=> '選択された複数のルールは無効です。 有効な値は、0～15の整数です。',
	'IP'						=> 'IPアドレス',
	...
	'NOT_ALLOWED_MANAGE_GROUP'	=> 'このグループを管理する権限がありません',
	'NOT_AUTHORISED'			=> 'このエリアにアクセスする権限がありません',
	...
	'NOTIFICATION_METHOD_INVALID'		=> 'メソッド "%s" は、有効な通知メソッドを参照していません。',
	...
	'REMOVE'					=> '削除',
	'REMOVE_INSTALL'			=> '掲示板を利用できるようにするには installディレクトリ を削除、移動、もしくは名前を変更する必要があります。installディレクトリ が存在している間は Adminコントロールパネル (AdminCP) だけしかアクセスできません。',
	'REPLIES'					=> '返信数',
	...
	'SORRY_AUTH_READ_TOPIC'		=> 'このトピックを参照する権限がありません',
	'SORRY_AUTH_VIEW_ATTACH'	=> '添付ファイルをダウンロードする権限がありません',
	'SORT_BY'					=> 'ソート',
	'SORT_DIRECTION'			=> '順序',
	'SORT_JOINED'				=> '登録日時',
	'SORT_LOCATION'				=> 'お住まい',
	'SORT_OPTIONS'				=> '表示とソートオプション',
	'SORT_RANK'					=> 'ランク',
	'SORT_POSTS'				=> '投稿数',
