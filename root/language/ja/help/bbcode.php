...
$lang = array_merge($lang, array(
	...
	'HELP_BBCODE_BLOCK_LINKS'	=> 'ハイパーリンクの作成',
	'HELP_BBCODE_BLOCK_LISTS'	=> 'リストの作成',
	'HELP_BBCODE_BLOCK_OTHERS'	=> 'その他',
	'HELP_BBCODE_BLOCK_QUOTES'	=> '引用と固定幅データの表示',
	...
	'HELP_BBCODE_INTRO_BBCODE_ANSWER'	=> 'BBCode はユーザーの利便性・システムの安全性のためにシステム側が用意した簡単なマークアップ言語です。BBCode を使用できるか否かは掲示板の設定によります。BBCode を使用できる場合でも投稿時に投稿画面で BBCode を無効にできます。 BBCode はマークアップ言語である点で HTML と似ていますが、タグは &lt; &gt; ではなく角カッコ [ ] で括られます。BBCode を使用することによって文章の見栄えをコントロールしたり画像やリンクを文章に挿入したりできるようになります。掲示板のスタイルによりますが、テキストエリアの真上に BBCode ボタンがずらりと並んでいるはずです。これらのボタンをクリックすれば簡単に BBCode をテキストエリア内に挿入できます。 BBCode をさらに詳しく知るには以下のガイドをご覧ください。',
	'HELP_BBCODE_INTRO_BBCODE_QUESTION'	=> 'BBCode とは?',

	'HELP_BBCODE_LINKS_BASIC_ANSWER'	=> 'BBCode は URI（niform Resource Indicators の略、URL と同義） を作成する方法をいくつかサポートしています。<ul><li>リンクしたい文字を <strong>[url=][/url]</strong> で囲みます。 = の後にリンク先の URL を入力します。例えば phpBB.com へのリンクを作る場合は次のようにします: <br /><br /><strong>[url=https://www.phpbb.com/]</strong>Visit phpBB!<strong>[/url]</strong><br /><br /> 上記のようにすると <a href="https://www.phpbb.com/">Visit phpBB!</a> と表示されます。リンククリック時に同じウィンドウで開くか新しいウィンドウで開くかはブラウザの設定に依存する点にご注意ください。</li><li>URL そのものをリンクにしたい場合は単純に次のようにします: <br /><br /><strong>[url]</strong>https://www.phpbb.com/<strong>[/url]</strong><br /><br /> 上記のようにすれば <a href="https://www.phpbb.com/">https://www.phpbb.com/</a> と表示されます。</li><li>phpBB には <i>マジックリンク</i> と呼ばれる機能が備わっています。マジックリンクは構文的に正しい URL をタグなしで自動的にリンク化する機能です。https:// さえ不要です。例えば www.phpbb.com と入力すると自動的に <a href="https://www.phpbb.com/">www.phpbb.com</a> と表示されます。</li><li>同じ事がメールアドレスにも言えます：<br /><br /><strong>[email]</strong>no.one@domain.adr<strong>[/email]</strong><br /><br /> 上記のようにすれば <a href="mailto:no.one@domain.adr">no.one@domain.adr</a> と表示されます。そしてタグをつけずに no.one@domain.adr と入力するだけで自動的にリンク化されます。</li></ul>URLタグ は <strong>[img][/img]</strong> （このタグについては次の項目をご参照ください）、<strong>[b][/b]</strong> など他の全ての BBCodeタグ を囲むことができます。複数のタグを使用する場合は開始タグと終了タグを正しく並べてください。次のタグの使い方は間違っている例です：<br /><br /><strong>[url=https://www.phpbb.com/][img]</strong>https://www.phpbb.com/theme/images/logos/blue/160x52.png<strong>[/url][/img]</strong><br /><br /> 上記の例は<span style="text-decoration: underline">誤った並べ方</span>なのでご注意ください。',
	'HELP_BBCODE_LINKS_BASIC_QUESTION'	=> '他サイトへのハイパーリンクの作成方法',

	'HELP_BBCODE_LISTS_ORDERER_ANSWER'	=> '番号付きリストを作成するには <strong>[list=1][/list]</strong> を用います。番号順の代わりにアルファベット順にしたい場合は <strong>[list=a][/list]</strong> を用います。番号なしリストと同様に各項目を指定するには <strong>[*]</strong> を使用します。簡単な例を紹介します：<br /><br /><strong>[list=1]</strong><br /><strong>[*]</strong>お店に行って<br /><strong>[*]</strong>パソコン買って<br /><strong>[*]</strong>故障したら悪態をつく<br /><strong>[/list]</strong><br /><br /> 上記のようにすると次のリストが表示されます: <ol style="list-style-type: decimal;"><li>お店に行って</li><li>パソコン買って</li><li>故障したら悪態をつく</li></ol> 次にアルファベット順リストの例を紹介します: <br /><br /><strong>[list=a]</strong><br /><strong>[*]</strong>第一候補<br /><strong>[*]</strong>第二候補<br /><strong>[*]</strong>第三候補<br /><strong>[/list]</strong><br /><br /> 上記のようにすると次のリストが表示されます：<ol style="list-style-type: lower-alpha"><li>第一候補</li><li>第二候補</li><li>第三候補</li></ol><br /><strong>[list=A]</strong><br /><strong>[*]</strong>第一候補<br /><strong>[*]</strong>第二候補<br /><strong>[*]</strong>第三候補<br /><strong>[/list]</strong><br /><br /> 上記のようにすると次のリストが表示されます：<ol style="list-style-type: upper-alpha"><li>第一候補</li><li>第二候補</li><li>第三候補</li></ol><br /><strong>[list=i]</strong><br /><strong>[*]</strong>第一候補<br /><strong>[*]</strong>第二候補<br /><strong>[*]</strong>第三候補<br /><strong>[/list]</strong><br /><br /> 上記のようにすると次のリストが表示されます：<ol style="list-style-type: lower-roman"><li>第一候補</li><li>第二候補</li><li>第三候補</li></ol><br /><strong>[list=I]</strong><br /><strong>[*]</strong>第一候補<br /><strong>[*]</strong>第二候補<br /><strong>[*]</strong>第三候補<br /><strong>[/list]</strong><br /><br /> 上記のようにすると次のリストが表示されます：<ol style="list-style-type: upper-roman"><li>第一候補</li><li>第二候補</li><li>第三候補</li></ol>',
	'HELP_BBCODE_LISTS_ORDERER_QUESTION'	=> '番号付きリストの作成方法',
	'HELP_BBCODE_LISTS_UNORDERER_ANSWER'	=> 'BBCode は 番号なしリスト と 番号付きリスト をサポートしています。BBCode のリストは HTML の &lt;li&gt; と同じように機能します。番号なしリストは各項目の先頭に丸い点が置かれます。番号なしリストを作成するには <strong>[list][/list]</strong> タグの中で <strong>[*]</strong> を使って各項目を指定します。例えば自分の好きな色をリスト表示するには次のようにします：<br /><br /><strong>[list]</strong><br /><strong>[*]</strong>Red<br /><strong>[*]</strong>Blue<br /><strong>[*]</strong>Yellow<br /><strong>[/list]</strong><br /><br /> 上記のようにすると次のリストが表示されます：<ul><li>Red</li><li>Blue</li><li>Yellow</li></ul><br />あるいは、[list=disc][/list], [list=circle][/list], or [list=square][/list] を使用してリストの箇条書きスタイルを指定することもできます。',
	'HELP_BBCODE_LISTS_UNORDERER_QUESTION'	=> '番号なしリストの作成方法',

	'HELP_BBCODE_OTHERS_CUSTOM_ANSWER'	=> 'もしあなたが Adminユーザー で且つ BBCode作成 のパーミッションを与えられていれば、Adminコントロールパネル で新しい BBCode を追加できます。',
