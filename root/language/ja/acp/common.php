...
$lang = array_merge($lang, array(
	...
	'VERSIONCHECK_INVALID_ENTRY'	=> '最新のバージョン情報にサポートされていない項目が含まれています。',
	'VERSIONCHECK_INVALID_URL'		=> '最新のバージョン情報に無効なURLが含まれています。',
	'VERSIONCHECK_INVALID_VERSION'	=> '最新のバージョン情報に無効なバージョンが含まれています。',
...
$lang = array_merge($lang, array(
	...
	'LOG_BBCODE_CONFIGURATION_ERROR'	=> '<strong>BBCode の設定中にエラーが発生しました</strong>: %1$s<br />» %2$s',
